...
<div class="container my-4">
  ...
  <div class="form-section">
    <h4 class="mb-3">Add Customer Profile</h4>
    <form method="POST" enctype="multipart/form-data">
      <div class="row g-3">
        <div class="col-md-4"><label class="form-label">Name</label><input name="customer_name" class="form-control" required></div>
        <div class="col-md-4"><label class="form-label">Father Name</label><input name="father_name" class="form-control" required></div>
        <div class="col-md-4"><label class="form-label">CNIC</label><input name="cnic" class="form-control" required></div>
        <div class="col-md-4"><label class="form-label">Phone</label><input name="phone" class="form-control" required></div>
        <div class="col-md-4"><label class="form-label">Address</label><input name="address" class="form-control" required></div>
      ...
      <div class="row mt-4">
        ...
        <div class="col-md-4">
          ...
          <input type="number" name="paid_amount" id="paid_amount" class="form-control" oninput="calculateRemaining()">
        </div>
        <div class="col-md-4">
          <label class="form-label">Remaining Amount (Rs)</label>
          <input type="number" name="remaining_amount" id="remaining_amount" class="form-control" readonly>
        </div>
      </div>
      ...
      <div class="row mt-3">
        <div class="col-md-6">
          ...
          <textarea name="document_details" class="form-control"></textarea>
        </div>
        <div class="col-md-6">
      ...
      <button type="submit" class="btn-primary-custom mt-3">Save Customer</button>
    </form>
  </div>
